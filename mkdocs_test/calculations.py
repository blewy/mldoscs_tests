# mkdocs_test/calculations.py
# if you have problem with poetry :https://stackoverflow.com/questions/60580332/poetry-virtual-environment-already-activated
"""Provide several sample math calculations.

This module allows the user to make mathematical calculations.

Examples:
    >>> from mkdocs_test import calculations
    >>> calculations.add(2, 4)
    6.0
    >>> calculations.multiply(2.0, 4.0)
    8.0
    >>> from mkdocs_test.calculations import divide
    >>> divide(4.0, 2)
    2.0
